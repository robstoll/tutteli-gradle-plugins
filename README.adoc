...
(and maybe out-dated, bare with me, as far as I know I am the only one using them).
...
[source,groovy]
.link:https://github.com/robstoll/tutteli-gradle/settings.gradle[settings.gradle]
----
include::settings.gradle[tags=example]
----
