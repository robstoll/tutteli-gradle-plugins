...
class KotlinUtilsPluginIntTest {
    ...
    void moduleInfoInSubprojectSucceeds(SettingsExtensionObject settingsSetup) {
        ...
        //assert
        Asserts.assertStatusOk(result, [':sub1:compileKotlin', ':sub1:compileModuleJava', ':sub1:jar'], [], [':sub1:classes'])
    ...
    static def moduleInfo(SettingsExtensionObject settingsSetup, String moduleInfoContent) throws IOException {
        ...
        ${buildscriptWithKotlin(settingsSetup)}
    ...
    private static String buildscriptWithKotlin(SettingsExtensionObject settingsSetup){
        return """
        buildscript {
