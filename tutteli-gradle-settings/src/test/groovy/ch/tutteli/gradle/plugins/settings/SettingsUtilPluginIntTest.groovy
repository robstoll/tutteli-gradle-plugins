...
import static ch.tutteli.gradle.plugins.test.Asserts.assertJvmJsInOutput
import static ch.tutteli.gradle.plugins.test.Asserts.assertJvmJsAndroidInOutput
...
class SettingsUtilPluginIntTest {
    ...
    void extensionVoodoo(SettingsExtensionObject settingsSetup) throws IOException {
       ...
       apply plugin: 'ch.tutteli.gradle.plugins.settings'
